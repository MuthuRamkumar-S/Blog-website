...
app.get('/posts/:topic',function(req,res){
  ...
  var reqtitle = _.toLower(req.params.topic)
  posts.forEach(function(element){
    var posttitle = _.toLower(element.title);
...
app.post('/getinp',function(req,res){
  let post = {title: req.body.postTitle, body : req.body.postBody}
  posts.push(post);
  res.redirect('/');
})
